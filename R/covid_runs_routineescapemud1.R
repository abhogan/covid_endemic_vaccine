...
scenarios <- readRDS("scenarios/scenarios_runs_routineescapemud1.rds")
...
run_scenario_new(
  ...
  age_groups_covered_d2 = scenarios_in$age_groups_covered_d2,
  t_d2 = scenarios_in$t_d2,
  ...
  ICU_scal = scenarios_in$ICU_scal,
