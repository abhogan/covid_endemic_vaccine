...
mu_ab_d1 = c(1.13/5.2*1, 1.13/5.2*1.5, 1.13/5.2*1.75, 1.13/5.2*2)
k = 2.5
hl_s = 35
hl_l = 1000
period_s <- 75
...
saveRDS(scenarios, "../covid_katana_runs/scenarios/scenarios_runs_calibrationagertb1.rds")

write_csv(scenarios, paste0("../covid_katana_runs/scenarios/scenarios_runs_calibrationagertb1.csv"))
