...
saveRDS(scenarios, "../covid_katana_runs/scenarios/scenarios_runs_routineage.rds")

write_csv(scenarios, paste0("../covid_katana_runs/scenarios/scenarios_runs_routineage.csv"))
